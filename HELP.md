...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring for RabbitMQ, Spring Batch'. As a result, your application may not work as expected.
